...
public class Toolbar extends HorizontalPanel {
	...
	for (i = 0; i < info.length; i += 3) {
		...
		iconLabel.getElement().setInnerHTML(variantButton.getElement().getInnerHTML());
	...
	iconLabel.addMouseOverHandler(event -> {
	    ...
	    int leftOffset = iconLabel.getAbsoluteLeft() - 8;
